...
PHOTO = BASE / "3" / "LINE_ALBUM_2026.7.6 _2_260706_2.jpg"
SRC = BASE / "002A4884.MP4"
OUT = BASE / "edit" / "cards_shengping" / "opening.mp4"
...
# regions in photo pixel coords (720x524) — 北一女畢業班紀念照
CAPTION = (85, 435, 650, 515)          # 台灣省立台北第一女子中學…紀念 (light on dark)
PEOPLE = (10, 95, 710, 440)

# (region, kind, t_start, t_end, direction)
INK_STEPS = [
    (CAPTION, "bright", 0.30, 2.40, "ltr"),
]
PEOPLE_T = (2.80, 6.10)
REST_T = (5.70, 6.60)
STRUCT_T = (0.30, 1.60)
