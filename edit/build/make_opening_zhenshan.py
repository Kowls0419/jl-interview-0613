...
PHOTO = BASE / "1" / "LINE_ALBUM_2026.7.6_260706_7.jpg"
SRC = BASE / "002A4884.MP4"
OUT = BASE / "edit" / "cards_zhenshan" / "opening.mp4"
...
# regions in photo pixel coords (1201x884) — 振山煤礦 staff photo, 民國37.4.1
INSCRIPTION = (770, 55, 1195, 180)     # 本坑職員移動留影 37.4.1 (white on foliage)
PEOPLE = (85, 195, 1145, 830)

# (region, kind, t_start, t_end, direction)
INK_STEPS = [
    (INSCRIPTION, "bright", 0.30, 2.30, "ltr"),
]
PEOPLE_T = (2.70, 6.10)
REST_T = (5.70, 6.60)
STRUCT_T = (0.30, 1.60)
